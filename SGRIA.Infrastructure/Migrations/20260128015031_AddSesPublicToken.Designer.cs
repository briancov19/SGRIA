...
namespace SGRIA.Infrastructure.Migrations
{
    ...
    [Migration("20260128015031_AddSesPublicToken")]
    partial class AddSesPublicToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGRIA.Domain.Entities.AnonDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("DeviceHash")
                        ...
                        .HasColumnName("DevHash");

                    b.Property<DateTime>("FechaCreacion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("DevFchaCreacion")
                    ...
                    b.ToTable("anon_devices", (string)null);
                });
            ...
            modelBuilder.Entity("SGRIA.Domain.Entities.SesionMesa", b =>
                {
                    ...
                    b.Property<DateTime>("FechaHoraUltActividad")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("SesFchaHoraUltActividad")
                        .HasDefaultValueSql("CURRENT_TIMESTAMP");
                    ...
                    b.Property<string>("SesPublicToken")
                        .IsRequired()
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)")
                        .HasColumnName("SesPublicToken");

                    b.HasKey("Id");

                    b.HasIndex("FechaHoraInicio");

                    b.HasIndex("FechaHoraUltActividad");

                    b.HasIndex("MesaId");

                    b.HasIndex("SesPublicToken")
                        .IsUnique();
            ...
            modelBuilder.Entity("SGRIA.Domain.Entities.SesionParticipante", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("AnonDeviceId")
                        .HasColumnType("integer")
                        .HasColumnName("ParDevId");

                    b.Property<DateTime>("FechaHoraJoin")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("ParFchaHoraJoin")
                        .HasDefaultValueSql("CURRENT_TIMESTAMP");

                    b.Property<int>("SesionMesaId")
                        .HasColumnType("integer")
                        .HasColumnName("ParSesId");

                    b.Property<DateTime>("UltimaActividad")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("ParUltimaActividad")
                        .HasDefaultValueSql("CURRENT_TIMESTAMP");

                    b.HasKey("Id");

                    b.HasIndex("AnonDeviceId");

                    b.HasIndex("UltimaActividad");

                    b.HasIndex("SesionMesaId", "AnonDeviceId");
            ...
            modelBuilder.Entity("SGRIA.Domain.Entities.SesionParticipante", b =>
                {
                    b.HasOne("SGRIA.Domain.Entities.AnonDevice", "AnonDevice")
                        .WithMany("Participantes")
                        .HasForeignKey("AnonDeviceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
